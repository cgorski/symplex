...
> **Pre-release (0.28).** The API is stabilising but not stable: 0.7.0 reshaped the
...
| Feature | symplex 0.28 | SymPy 1.14 |
|---------|--------------|------------|
