...
> **Pre-release (0.27).** The API is stabilising but not stable: 0.7.0 reshaped the
...
| Feature | symplex 0.27 | SymPy 1.14 |
|---------|--------------|------------|
