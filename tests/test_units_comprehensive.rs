...
fn diff_length_wrt_time_is_velocity() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; a, t);
...
fn diff_angle_wrt_time_is_angular_velocity() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; w, t);
...
fn diff_energy_wrt_time_is_power() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; p, t);
...
fn diff_momentum_wrt_time_is_force() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; f, t);
...
fn diff_angular_momentum_wrt_time_is_torque() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; tau, t);
...
fn diff_charge_wrt_time_is_current() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; i, t);
...
fn diff_magnetic_flux_wrt_time_is_voltage() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; v, t);
...
fn diff_energy_wrt_length_is_force() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; f, x);
...
fn diff_energy_wrt_angle_is_torque() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; tau, theta);
...
fn diff_energy_wrt_velocity_is_momentum() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; p, v);
...
fn diff_energy_wrt_angular_velocity_is_angular_momentum() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; l, w);
...
fn diff_power_wrt_current_is_voltage() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; v, i);
...
fn diff_power_wrt_voltage_is_current() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; i, v);
...
fn diff_momentum_wrt_length_is_stiffness() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; k, x);
...
fn to_latex_preserves_dimension() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; f);
    let force = Force::from_ex(expr!(f));
...
fn asref_qty_returns_ex() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let q: Qty<LengthDim> = Qty::from_ex(__ctx.int(42));
    let ex: &Ex = q.as_ref();
...
fn subs_still_accepts_raw_ex() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; m, a);
    let m_ex = __ctx.symbol("m");
    let f = Force::from_ex(expr!(m * a));
    // subs with raw &Ex — backward compatible
    let f2 = f.subs(&m_ex, &__ctx.int(10));
...
fn subs_chain_no_inner() {
    ...
    let result = f.subs(&m_var, &__ctx.int(5)).subs(&a_var, &__ctx.int(10)).eval();
...
fn diff_accepts_named_type_var() {
    let __ctx = symplex::units::si::units_ctx().clone();
    let __vars_ctx = __ctx.clone(); symplex::syms!(__vars_ctx; x, t);
...
fn qty_subs_accepts_named_type() {
    ...
    let m_var = Mass::symbol("m");
    let q2 = q.subs(&m_var, &__ctx.int(7));
