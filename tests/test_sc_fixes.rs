...
fn zero_times_add_with_pos_infinity_is_nan() {
    ...
    let sum = &x + &oo;
    let expr = &symplex::default_context().int(0) * &sum;
    assert_eq!(
        format!("{expr}"),
        "nan",
...
fn zero_times_add_with_neg_infinity_is_nan() {
    let neg_oo = symplex::default_context().neg_infinity();
    let x = symplex::default_context().symbol("x");
    let sum = &x + &neg_oo;
    let expr = &symplex::default_context().int(0) * &sum;
    assert_eq!(
...
fn zero_times_finite_add_is_zero() {
    let x = symplex::default_context().symbol("x");
    let sum = &x + &symplex::default_context().int(1);
    let expr = &symplex::default_context().int(0) * &sum;
...
fn zero_times_bare_infinity_is_nan() {
    ...
    let expr = &symplex::default_context().int(0) * &symplex::default_context().infinity();
...
fn zero_times_symbol_is_zero() {
    let x = symplex::default_context().symbol("x");
    let expr = &symplex::default_context().int(0) * &x;
...
fn fast_path_add_two_integers() {
    let a = symplex::default_context().int(7);
    let b = symplex::default_context().int(13);
    let result = &a + &b;
...
fn fast_path_add_two_rationals() {
    ...
    let b = symplex::default_context().rational(1, 6);
    let result = &a + &b;
...
fn fast_path_add_cancels_to_zero() {
    let a = symplex::default_context().int(5);
    let b = symplex::default_context().int(-5);
    let result = &a + &b;
...
fn fast_path_mul_two_integers() {
    let a = symplex::default_context().int(6);
    let b = symplex::default_context().int(7);
    let result = &a * &b;
...
fn fast_path_mul_two_rationals() {
    let a = symplex::default_context().rational(2, 3);
    let b = symplex::default_context().rational(3, 4);
    let result = &a * &b;
...
fn fast_path_mul_to_one() {
    let a = symplex::default_context().rational(3, 7);
    let b = symplex::default_context().rational(7, 3);
    let result = &a * &b;
...
fn fast_path_mul_to_zero() {
    let a = symplex::default_context().int(0);
    let b = symplex::default_context().int(99);
    let result = &a * &b;
