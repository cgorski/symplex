...
fn zero_times_bare_infinity_is_nan() {
    ...
    let expr = &__ctx.int(0) * &__ctx.infinity();
...
fn fast_path_mul_two_rationals() {
    let __ctx = Context::new();
    let a = __ctx.rational(2, 3);
    let b = __ctx.rational(3, 4);
    let result = &a * &b;
...
fn fast_path_mul_to_one() {
    let __ctx = Context::new();
    let a = __ctx.rational(3, 7);
    let b = __ctx.rational(7, 3);
    let result = &a * &b;
