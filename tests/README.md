...
~360 integration-test source files (~10 000 `#[test]`s) compiled into **21
test binaries**, plus the SymPy oracle described below.  (The crate's inline
unit tests add ~2 800, and `cargo test --doc` runs ~1 030 API doctests plus
the ~230 Rust blocks of `README.md` and the book, wired in `src/doctests.rs`.)  Everything runs with
...
~6.5 min to link and ~13 GB of `target/`; 21 take seconds.  A new
