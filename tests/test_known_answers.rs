...
fn diff_const_7() {
    let x = symplex::var("x");
    check(&symplex::int(7).diff(&x), "0");
}

#[test]
fn diff_const_0() {
    let x = symplex::var("x");
    check(&symplex::int(0).diff(&x), "0");
}

#[test]
fn diff_const_neg3() {
    let x = symplex::var("x");
    check(&symplex::int(-3).diff(&x), "0");
}
...
fn int_1() {
    let x = symplex::var("x");
    check(&symplex::int(1).integrate(&x), "x");
}
...
fn int_const_5() {
    let x = symplex::var("x");
    check(&symplex::int(5).integrate(&x), "5*x");
}

#[test]
fn int_zero() {
    let x = symplex::var("x");
    check(&symplex::int(0).integrate(&x), "0");
}
...
fn solve_constant_nonzero_no_solutions() {
    let x = symplex::var("x");
    let r = symplex::int(5).solve_or_empty(&x);
...
fn solve_constant_zero_no_solutions() {
    let x = symplex::var("x");
    let r = symplex::int(0).solve_or_empty(&x);
...
#[test]
fn eval_sin_0() {
    check(&symplex::int(0).sin().eval(), "0");
}

#[test]
fn eval_cos_0() {
    check(&symplex::int(0).cos().eval(), "1");
}

#[test]
fn eval_tan_0() {
    check(&symplex::int(0).tan().eval(), "0");
}
...
#[test]
fn eval_sin_pi() {
    check(&symplex::pi().sin().eval(), "0");
}

#[test]
fn eval_cos_pi() {
    check(&symplex::pi().cos().eval(), "-1");
}
...
#[test]
fn eval_exp_0() {
    check(&symplex::int(0).exp().eval(), "1");
}

#[test]
fn eval_ln_1() {
    check(&symplex::int(1).ln().eval(), "0");
}

#[test]
fn eval_ln_e() {
    check(&symplex::e().ln().eval(), "1");
}
...
#[test]
fn eval_i_squared() {
    check(&symplex::i_unit().powi(2), "-1");
}

#[test]
fn eval_i_cubed() {
    check(&symplex::i_unit().powi(3), "-I");
}

#[test]
fn eval_i_fourth() {
    check(&symplex::i_unit().powi(4), "1");
}

#[test]
fn eval_i_to_100() {
    check(&symplex::i_unit().powi(100), "1");
}

#[test]
fn eval_i_to_neg_1() {
    check(&symplex::i_unit().powi(-1), "-I");
}
...
fn eval_exp_i_pi() {
    ...
    check(&(&i * &symplex::pi()).exp().eval(), "-1");
}

#[test]
fn eval_exp_i_pi_over_2() {
    let i = symplex::i_unit();
    let angle = &symplex::default_context().rational(1, 2) * &symplex::pi();
...
fn eval_euler_identity_zero() {
    let i = symplex::i_unit();
    let euler = &(&i * &symplex::pi()).exp().eval() + 1;
    check(&euler, "0");
}
...
#[test]
fn eval_sqrt_4() {
    check(&symplex::int(4).sqrt().eval(), "2");
}

#[test]
fn eval_sqrt_9() {
    check(&symplex::int(9).sqrt().eval(), "3");
}

#[test]
fn eval_sqrt_16() {
    check(&symplex::int(16).sqrt().eval(), "4");
}

#[test]
fn eval_sqrt_25() {
    check(&symplex::int(25).sqrt().eval(), "5");
}

#[test]
fn eval_sqrt_8() {
    check(&symplex::int(8).sqrt().eval(), "2*sqrt(2)");
}
...
#[test]
fn eval_asin_0() {
    check(&symplex::int(0).asin().eval(), "0");
}

#[test]
fn eval_asin_1() {
    let r = symplex::int(1).asin().eval();
    check_contains(&r, &["pi"], "asin(1) should be π/2");
}

#[test]
fn eval_acos_1() {
    check(&symplex::int(1).acos().eval(), "0");
}

#[test]
fn eval_atan_0() {
    check(&symplex::int(0).atan().eval(), "0");
}
...
#[test]
fn eval_sinh_0() {
    check(&symplex::int(0).sinh().eval(), "0");
}

#[test]
fn eval_cosh_0() {
    check(&symplex::int(0).cosh().eval(), "1");
}

#[test]
fn eval_tanh_0() {
    check(&symplex::int(0).tanh().eval(), "0");
}
...
#[test]
fn eval_asinh_0() {
    check(&symplex::int(0).asinh().eval(), "0");
}

#[test]
fn eval_acosh_1() {
    check(&symplex::int(1).acosh().eval(), "0");
}

#[test]
fn eval_atanh_0() {
    check(&symplex::int(0).atanh().eval(), "0");
}
...
#[test]
fn eval_ln_neg_1() {
    check(&symplex::int(-1).ln().eval(), "pi*I");
}

#[test]
fn eval_ln_neg_2() {
    let r = symplex::int(-2).ln().eval();
    let s = format!("{r}");
    assert!(
...
#[test]
fn eval_abs_3() {
    check(&symplex::int(3).abs().eval(), "3");
}
...
#[test]
fn eval_abs_0() {
    check(&symplex::int(0).abs().eval(), "0");
}

#[test]
fn eval_abs_i() {
    check(&symplex::i_unit().abs().eval(), "1");
}
...
fn simp_abs_positive() {
    check(&symplex::int(5).abs().simplify(), "5");
}
...
#[test]
fn display_i() {
    check(&symplex::i_unit(), "I");
}

#[test]
fn display_int_42() {
    check(&symplex::int(42), "42");
}

#[test]
fn display_rational_half() {
    check(&symplex::rational(1, 2), "1/2");
}

#[test]
fn display_rational_third() {
    check(&symplex::rational(1, 3), "1/3");
}
...
fn assume_positive_int() {
    assert_eq!(symplex::int(5).is_positive(), Some(true));
}

#[test]
fn assume_negative_int() {
    assert_eq!(symplex::int(-3).is_negative(), Some(true));
}

#[test]
fn assume_zero_is_not_positive() {
    assert_eq!(symplex::int(0).is_positive(), Some(false));
}

#[test]
fn assume_integer_on_integer() {
    assert_eq!(symplex::int(7).is_integer(), Some(true));
}

#[test]
fn assume_real_on_integer() {
    assert_eq!(symplex::int(5).is_real(), Some(true));
}

#[test]
fn assume_real_on_pi() {
    assert_eq!(symplex::pi().is_real(), Some(true));
}

#[test]
fn assume_not_real_on_i() {
    assert_eq!(symplex::i_unit().is_real(), Some(false));
}

#[test]
fn assume_imaginary_on_i() {
    assert_eq!(symplex::i_unit().is_imaginary(), Some(true));
}

#[test]
fn assume_finite_on_int() {
    assert_eq!(symplex::int(5).is_finite(), Some(true));
}

#[test]
fn assume_not_finite_on_inf() {
    assert_eq!(symplex::infinity().is_finite(), Some(false));
}

#[test]
fn assume_nonzero_on_5() {
    assert_eq!(symplex::int(5).is_nonzero(), Some(true));
}

#[test]
fn assume_not_nonzero_on_0() {
    assert_eq!(symplex::int(0).is_nonzero(), Some(false));
}
...
fn assume_rational_is_not_integer() {
    assert_eq!(symplex::rational(1, 2).is_integer(), Some(false));
}
...
fn free_symbols_constant_empty() {
    assert!(symplex::pi().free_symbols().is_empty());
}
