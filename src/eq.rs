...
pub struct Equation {
    ...
    pub lhs: crate::expr::Ex,
    /// Right-hand side of the equation.
    pub rhs: crate::expr::Ex,
}

impl Equation {
    /// Create a new equation `lhs = rhs`.
    pub fn new(lhs: crate::expr::Ex, rhs: crate::expr::Ex) -> Self {
        Self { lhs, rhs }
    }
    ...
    pub fn solve(
        &self,
        var: &crate::expr::Ex,
    ) -> Result<Vec<crate::expr::Ex>, crate::errors::SymplexError> {
        let diff = &self.lhs - &self.rhs;
        diff.solve(var)
    }

    /// Solve this equation, returning empty vec on failure.
    pub fn solve_or_empty(&self, var: &crate::expr::Ex) -> Vec<crate::expr::Ex> {
        let diff = &self.lhs - &self.rhs;
        diff.solve_or_empty(var)
    }

    /// Substitute a variable in both sides.
    pub fn subs(&self, old: &crate::expr::Ex, new: &crate::expr::Ex) -> Equation {
        Equation {
    ...
    pub fn subs_i64(&self, old: &crate::expr::Ex, val: i64) -> Equation {
        Equation {
    ...
    pub fn to_expr(&self) -> crate::expr::Ex {
        &self.lhs - &self.rhs
    }
}
