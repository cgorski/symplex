...
fn do_inverse(
    ...
    let decomposed = crate::apart::apart(arena, expr, s);
    if decomposed != expr {
...
fn try_table_inverse(arena: &mut Arena, expr: ExprId, s: ExprId, t: ExprId) -> Option<ExprId> {
    ...
    let denom_poly = crate::polybridge::expr_to_poly(arena, denom, s)?;
...
fn inverse_degree1(
    ...
    let numer_poly = crate::polybridge::expr_to_poly(arena, numer, s)?;
...
fn inverse_degree2(
    ...
    if b.is_zero() {
        ...
        let omega_id = {
            ...
            crate::eval::eval(arena, raw_sqrt)
        };
