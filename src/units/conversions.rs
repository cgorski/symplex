...
impl Length {
    ...
    pub fn centimeters(val: &Ex) -> Self { Length(val * &crate::rational(1, 100)) }

    /// Create a Length from a value in millimeters.
    pub fn millimeters(val: &Ex) -> Self { Length(val * &crate::rational(1, 1000)) }
...
impl Mass {
    ...
    pub fn grams(val: &Ex) -> Self { Mass(val * &crate::rational(1, 1000)) }

    /// Create a Mass from a value in milligrams.
    pub fn milligrams(val: &Ex) -> Self { Mass(val * &crate::rational(1, 1_000_000)) }
...
impl Time {
    ...
    pub fn milliseconds(val: &Ex) -> Self { Time(val * &crate::rational(1, 1000)) }

    /// Create a Time from a value in microseconds.
    pub fn microseconds(val: &Ex) -> Self { Time(val * &crate::rational(1, 1_000_000)) }

    /// Create a Time from a value in nanoseconds.
    pub fn nanoseconds(val: &Ex) -> Self { Time(val * &crate::rational(1, 1_000_000_000)) }
...
impl Voltage {
    ...
    pub fn millivolts(val: &Ex) -> Self { Voltage(val * &crate::rational(1, 1000)) }
...
impl Current {
    ...
    pub fn milliamperes(val: &Ex) -> Self { Current(val * &crate::rational(1, 1000)) }

    /// Create a Current from a value in microamperes (1 µA = 0.000001 A).
    pub fn microamperes(val: &Ex) -> Self { Current(val * &crate::rational(1, 1_000_000)) }
}
...
impl Resistance {
    ...
    pub fn milliohms(val: &Ex) -> Self { Resistance(val * &crate::rational(1, 1000)) }
...
impl Temperature {
    ...
    pub fn from_celsius(val: &Ex) -> Self {
        Temperature(val + &crate::rational(27315, 100))
    }
...
impl Area {
    ...
    pub fn square_centimeters(val: &Ex) -> Self { Area(val * &crate::rational(1, 10_000)) }
...
impl Volume {
    ...
    pub fn liters(val: &Ex) -> Self { Volume(val * &crate::rational(1, 1000)) }
...
impl Charge {
    ...
    pub fn milliampere_hours(val: &Ex) -> Self { Charge(val * &crate::rational(36, 10)) }
...
impl Inductance {
    ...
    pub fn millihenrys(val: &Ex) -> Self { Inductance(val * &crate::rational(1, 1000)) }

    /// Create an Inductance from a value in microhenrys (1 µH = 1e-6 H).
    pub fn microhenrys(val: &Ex) -> Self { Inductance(val * &crate::rational(1, 1_000_000)) }
}
...
impl Dimensionless {
    ...
    pub fn percent(val: &Ex) -> Self { Dimensionless(val * &crate::rational(1, 100)) }

    /// Create a Dimensionless quantity from a value in parts per thousand (‰).
    pub fn per_mille(val: &Ex) -> Self { Dimensionless(val * &crate::rational(1, 1000)) }
}
