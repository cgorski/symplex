...
pub(crate) fn transfer_subtree(
    ...
    let post_order = crate::walk::post_order_ids(src, root);
...
mod tests {
    ...
    fn transfer_preserves_assumptions() {
        ...
        assumptions.known_true |= crate::assumptions::Props::POSITIVE;
        assumptions.known_true |= crate::assumptions::Props::REAL;
        ...
        assert!(
            new_assumptions
                .known_true
                .contains(crate::assumptions::Props::POSITIVE)
        );
        assert!(
            new_assumptions
                .known_true
                .contains(crate::assumptions::Props::REAL)
        );
    }
