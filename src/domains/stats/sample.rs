...
/// The deterministic pseudo-random generator of the statistics layer:
/// [`SplitMix64`](crate::base::rng::SplitMix64) under its historical
/// name.  Not cryptographic; seeded, reproducible, and good enough for
/// Monte-Carlo sanity checks of exact results.
