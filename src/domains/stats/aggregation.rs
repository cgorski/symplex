...
//! per-category precision / recall / F₁, confidence intervals for a
//! proportion, gold-question screening).
//!
...
///
/// ```
/// use symplex::stats::aggregation::{proportion_interval, IntervalMethod};
///
