...
mod tests {
    ...
    #[test]
    fn refine_no_change() {
        let x = crate::var("x_ref_noop");
        let expr = &x + &crate::int(1);
        let result = do_refine(&expr);
