...
fn simplify_factorial_mul(arena: &mut Arena, original: ExprId, children: &[ExprId]) -> ExprId {
    ...
    for ni in 0..numer_facts.len() {
        for di in 0..denom_facts.len() {
            ...
            let diff_eval = crate::transforms::eval::eval(arena, diff_expr);
                ...
                if k > 0 && k <= 20 {
                    ...
                    let replacement = if k == 1 {
                        ...
                        for i in 1..=k {
                            ...
                            let factor_eval = crate::transforms::eval::eval(arena, factor);
    ...
    if numer_facts.len() == 1 && denom_facts.len() == 2 {
        ...
        let sum_eval = crate::transforms::eval::eval(arena, sum_expr);
...
mod tests {
    ...
    fn factorial_ratio_concrete_5_over_4() {
        ...
        let evaled = crate::transforms::eval::eval(&mut arena, ratio);
