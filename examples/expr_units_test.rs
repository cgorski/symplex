...
fn pattern_1_expr_and_from_ex() {
    ...
    let ke_val = ke.clone()
        ...
        .subs(&v, &symplex::default_context().int(3))
        .eval();
...
fn pattern_4_kinematics_chain() {
    ...
    let x_num = position.clone()
        ...
        .subs(&t, &symplex::default_context().int(2))
        .subs(&v0, &symplex::default_context().int(5))
        .subs(&x0, &symplex::default_context().int(0))
        .eval();
...
fn pattern_6_pendulum_lagrangian() {
    ...
    let torque_at = dl_dtheta_simplified
        ...
        .subs(&g, &symplex::default_context().rational(981, 100))
        .subs(&l, &symplex::default_context().rational(1, 2))
        .subs(&theta, &symplex::default_context().rational(1, 10))  // θ = 0.1 rad
        .eval();
...
fn pattern_8_unit_conversions() {
    ...
    let rpm_val = symplex::default_context().int(3600);
